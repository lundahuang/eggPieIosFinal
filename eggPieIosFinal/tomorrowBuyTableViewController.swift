//
//  tomorrowBuyTableViewController.swift
//  eggpieIosFinal
//
...
class tomorrowBuyTableViewController: UITableViewController {
    ...
    func updateFile(){
        ...
        let url = docUrl?.appendingPathComponent("buy.txt")
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(
            tomorrowBuyTableViewController.additemNoti(noti:)), name: notiName, object: nil)
    }
